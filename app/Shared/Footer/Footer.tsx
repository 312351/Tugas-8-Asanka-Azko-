            ...
            <div className="w-full min-h-[5vh] bg-[#E82800] py-5 px-3 flex flex-col gap-y-5">
               ...
               <div className={`${Open == "Menu" ? "" :""} transform transition-all duration-500 w-full flex flex-col bg-[#ffffff5e] rounded-2xl p-3 gap-y-3`}>
                    ...
                    <div className="w-full min-h-[15vh] font-bold opacity-75">
                        <p>AZKO&sbquo; s Your Home Life Improvement Partner AZKO adalah #AwalCeritaEvolusi 30 tahun bersama&sbquo; kini saatnya Awali Cerita Evolusi Baru bersama AZKO Ragam inspirasi dari A-Z&sbquo; membuka kemungkinan tanpa batas. Merek retail rumah tangga dan gaya hidup terbaru dari Kawan Lama Pusat perlengkapan rumah dan gaya hidup terlengkap di Indonesia hanya di AZKO&sbquo; bagian dari Kawan Lama Group! Pilih produk berkualitas dari STORA&sbquo; KRISBOW&sbquo; KRISBOW SYNC&sbquo; KRIS&sbquo; KLAZ&sbquo; SOLEIL&sbquo; KINETIC&sbquo; PASSPORT&sbquo; KINDLA&sbquo; OTTO KLASSE&sbquo; PROCLEAN&sbquo; SLEEPLITE&sbquo; CULINART&sbquo; FOSA&sbquo; PAWS &apos;N TAILS&sbquo; ARTHOME&sbquo; LUGGO&sbquo; MAXBUILT&sbquo; MEMOO&sbquo; BREATHE&sbquo; dan merek ternama seperti HUROM&sbquo; SCRUB DADDY&sbquo; & ASTONISH. Dapatkan promo terbaik untuk produk dapur&sbquo; kebersihan&sbquo; rak&sbquo; penyimpanan&sbquo; olahraga&sbquo; outdoor&sbquo; kompor portable&sbquo; air purifier&sbquo; pendingin udara&sbquo; lampu LED&sbquo; treadmill&sbquo; slow juicer&sbquo; serta ide hadiah atau kado unik. Inspirasi rumah modern & gaya hidup dimulai di AZKO!</p>
                    </div>
                    )}
               </div>
            </div>
